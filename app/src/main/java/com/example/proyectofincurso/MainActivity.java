...
import com.example.proyectofincurso.activities.UsersListActivity;
        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        //PARA INCLUIR EL TABLAYOUT EN EL MAINACTIVITY
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_biblioteca) {
            ...
            Intent intent = new Intent(getApplicationContext(),MainActivityLibro.class);
            startActivity(intent);

            Toast.makeText(getApplicationContext(), "Has pulsado sobre Libreria ", Toast.LENGTH_SHORT).show();
